    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('alpha.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3 mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="bulan_range" name="bulan_range" class="form-control" placeholder="Pilih rentang bulan">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="rentang_sanksi" class="form-label">Rentang Sanksi Berlaku</label>
                            <input type="text" name="rentang_sanksi" class="form-control" id="rentang_sanksi" required>
                        </div>
                        <div class="col-md-6">
...
<script>
    ...
    document.getElementById('bulan_range').addEventListener('change', function () {
        ...
        if (start && end) {
            fetch('{{ route('alpha.hitung_tidak_hadir') }}', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                },
                body: JSON.stringify({ bulan_range: `${start} to ${end}`, pegawai_id: pegawai_id })
            })
            .then(res => res.json())
            .then(data => {
